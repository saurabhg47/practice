...
params = {
    'src': '18889781470', # Sender's phone number with country code
    'dst' : '919770485870', # Receiver's phone Number with country code
    'text' : u"Hello, how are you, where r u bro?", # Your SMS Text Message - English
